...
https://slides.com/timpietrusky/livejs-frankenjs-2017
...
* 1 x [Eurolite B-100 Bubble Machine](https://www.prolighting.de/lichttechnik/nebel-spezialeffekte/seifenblasen/maschinen/eurolite-b-100-seifenblasenmaschine-schwarz-dmx.html)
...
Stuff that we send to the organisers in advance, so we are sure that everything is set the day we have the talk / show.

### Questions

1. Can the lights (that point to the stage) be turned off?
2. Can we practise the talk in the venue?
